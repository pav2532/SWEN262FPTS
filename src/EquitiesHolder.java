...
public class EquitiesHolder {
	 ...
	 * returns a Hashmap of the Holdings that match the search terms.
	 * @param searchTerms - Array of terms to search with
	...
	/**
	 * Searches through the Indices HashMap and adds any Indices that 
	 * contain the search term.
	 * 
	 * @param results	HashMap to store results in
	 * @param term	Term to search with. Uses pattern matches
	 ...
	 * keys that contain the term @param, otherwise the given results HashMap
	 * is searched and elements that cannot be matched to the search term are 
	 * removed.
	 * 
	 * @param results	HashMap to store results in
	 * @param term	Term to search against Holding Ticker Symbols. Uses pattern matching
	 * @return	returns a HashMap of results
	 */
	 ...
	 * 
	 * @param results	HashMap to store results in
	 * @param term	Term to search against holding name with. Uses pattern matching
	 * @return	returns a HashMap of results
	 */
