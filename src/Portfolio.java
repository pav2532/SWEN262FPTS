...
public class Portfolio {
	...
	public Portfolio(String name, ArrayList<Account> allAccount, HashMap<String, Integer> holding,
	...
	public void save() throws IOException {
		...
		try {
			...
			for (int i = 0; i < allAccount.size(); i++) {
				writer.println("B," + allAccount.get(i).getName() + "," + allAccount.get(i).getBalance() + ","
						+ allAccount.get(i).getDateCreated());
			}
